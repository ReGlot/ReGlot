<dl>
	...
	<dt><label for="project[description]"><?php _e('Description', 'glotpress');  ?></label> <span class="ternary">can include HTML</span></dt>
	...
	<dd>
		...
		<span class="ternary"><?php _e('Public URL to a source file in the project. You can use <code>%file%</code> and <code>%line%</code>. Ex. <code>http://trac.example.org/browser/%file%#L%line%</code>', 'glotpress'); ?></span>
	</dd>

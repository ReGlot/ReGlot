...
gp_breadcrumb(array(__('Install', 'glotpress')));
...
<br/>
	...
	<dd>
		...
		<small><?php _e('You can generate these using the <a href="https://api.wordpress.org/secret-key/1.1/" target="_blank">WordPress.org secret-key service</a> page', 'glotpress'); ?></small>
	</dd>
<br/>
	<dt>
		...
		<label for="config[gp_enable_wordpress_users]"><?php echo __('Enable WordPress User Base Integration', 'glotpress'); ?></label></h3>
	</dt>
...
<br/>
	<dt><h3><?php echo __('Other Options', 'glotpress'); ?></h3></dt>
	<dd>
		<label for="config[GP_LANG]"><?php echo __('GlotPress Language', 'glotpress'); ?></label>
		<input type="text" name="config[GP_LANG]" value="" id="config[CUSTOM_USER_TABLE]"><br/>
		<small><?php _e('A corresponding MO file for the chosen language must be installed to <i>languages/</i>. Leave blank for English.', 'glotpress'); ?></small>
	</dd>
</dl>
...
<?php echo gp_js_focus_on('config[GPDB_NAME]'); ?>
	...
	<p>
		<input type="submit" name="submit" value="<?php echo esc_attr(__('Install', 'glotpress')); ?>" id="submit" />
	</p>
</form>
